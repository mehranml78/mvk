    ...
    constructor(props) {
        ...
        this.state = {
            features : [
                ...
                {id : 2, img : feature2, icon : "mdi  mdi-account-group", title : "Team Management", desc : "Sed perspiciatis unde omnis natus error voluptatem accusantium doloremque laudantium totam rem aperiam eaque ipsa quae ab illo excepturi sint occaecati cupiditate architecto.", link : "/"},
